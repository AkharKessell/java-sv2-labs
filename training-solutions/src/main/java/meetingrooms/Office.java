...
public class Office {
    ...
    public void printAreas() {
        System.out.printf("A tárgyaló adatai:");
        for (MeetingRoom room : meetingRooms) {
            System.out.printf("%30s , %10d , %10d , %10d%n", room.getName() + "Neve", room.getWidth() + "Szélessége", room.getLength() + "Hossza", room.getArea() + "Területe");
        }
    }
