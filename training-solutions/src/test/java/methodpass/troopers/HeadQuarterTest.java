...
class HeadQuarterTest {
    ...
    void testAddTrooper() {
        ...
        Trooper trooper = new Trooper("Jane Doe");

        headQuarter.addTrooper(trooper);

        assertEquals(1, headQuarter.getTroopers().size());
        assertEquals("Jane Doe", headQuarter.getTroopers().get(0).getName());
    }
    ...
    void testMoveTrooperByName() {
        ...
        Trooper jakeTrooper = new Trooper("Jane Doe");

        headQuarter.addTrooper(johnTrooper);
        headQuarter.addTrooper(jakeTrooper);

        headQuarter.moveTrooperByName("Jane Doe", new Position(4, 7));
